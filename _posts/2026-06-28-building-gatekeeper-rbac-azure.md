...
tags: [csharp, dotnet, azure, rbac, security, github-actions]
...
> Part 2 — [Bridging the Gap: Connecting React (Azure SWA) to a Secured .NET 8 API]({% post_url 2026-06-29-connecting-react-swa-dontnet-api-azure %}) — covers wiring a React frontend hosted on Azure Static Web Apps to this secured backend.
...
> **Continue reading:** [Bridging the Gap: Connecting React (Azure SWA) to a Secured .NET 8 API]({% post_url 2026-06-29-connecting-react-swa-dontnet-api-azure %})
